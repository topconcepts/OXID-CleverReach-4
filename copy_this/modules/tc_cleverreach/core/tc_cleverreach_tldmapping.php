 ...
 */
class tc_cleverreach_tldmapping {

    /**
     * class instance object
     * @var tc_cleverreach_tldmapping
     */
     ...
     *
     * @return tc_cleverreach_tldmapping
     */
    public static function getInstance() {
        if (self::$instance === null) {
            self::$instance = oxNew('tc_cleverreach_tldmapping');
        }
    ...
    public function __construct() {
        $configMapping = oxRegistry::getConfig()->getConfigParam('tc_cleverreach_tldmapping');
    ...
    public function getCountryByTld($tld) {
        ...
        $country = oxDb::getDb()->getOne("select oxtitle from oxcountry where oxisoalpha2 = ?", array($iso2));
