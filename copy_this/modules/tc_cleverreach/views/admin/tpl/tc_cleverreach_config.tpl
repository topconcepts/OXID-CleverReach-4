...
<script src="[{ $oViewConf->getModuleUrl('tc_cleverreach', 'out/src/js/lib/jquery.min.js') }]"></script>
<script src="[{ $oViewConf->getModuleUrl('tc_cleverreach', 'out/src/js/lib/bootstrap.min.js') }]"></script>
<script src="[{ $oViewConf->getModuleUrl('tc_cleverreach', 'out/src/js/lib/tooltipster.bundle.min.js') }]"></script>
<script src="[{ $oViewConf->getModuleUrl('tc_cleverreach', 'out/src/js/tc_cleverreach_tooltips.js') }]"></script>
<link rel="stylesheet" href="[{ $oViewConf->getModuleUrl('tc_cleverreach', 'out/src/css/tc_cleverreach_style.css') }]">
<link rel="stylesheet" href="[{ $oViewConf->getModuleUrl('tc_cleverreach', 'out/src/css/tooltipster.bundle.min.css') }]">
<link rel="stylesheet" href="[{ $oViewConf->getModuleUrl('tc_cleverreach', 'out/src/css/tooltipster-sideTip-light.min.css') }]">
...
<form name="transfer" id="transfer" action="[{ $oViewConf->getSelfLink() }]" method="post">
    ...
    <input type="hidden" name="cl" value="tc_cleverreach_config">
</form>
<div class="container">
        ...
        <div class="first-usage">
            <div class="panel panel-default panel-quickmail">
                <div class="panel-body">
                    <img src="[{$oView->getCleverreachModuleUrl()|cat:'out/src/img/icon_quickstartmailing.svg'}]"
    ...
    [{else}]
        ...
        <div class="oauth-status row">
            ...
            <form action="[{$oViewConf->getSelfLink()}]" method="post" class="form-inline" name="form-disconnect-list" id="form-disconnect-list">
                <input type="hidden" name="cl" value="tc_cleverreach_config">
        ...
        [{if !$oView->getListId()}]
            ...
            <form action="[{$oViewConf->getSelfLink()}]" method="post" class="form-inline" name="form-select-list" id="form-select-list">
                [{$oViewConf->getHiddenSid()}]
        ...
        [{else}]
            <div class="first-usage">
                <div class="panel panel-default panel-quickmail">
                    <div class="panel-body">
                        ...
                        <form action="[{$oViewConf->getSelfLink()}]" method="post" target="tc_cleverreach_transfer_manual">
                            <input type="hidden" name="cl" value="tc_cleverreach_transfer_manual">
            ...
            <div class="tc_div_paths">
                <div style="margin-bottom: 5px;">
                    ...
                    <br>
                    <span>
                        "/usr/bin/php [{$oViewConf->getModulePath('tc_cleverreach', "/")}]crons/tc_cleverreach.php"
                    </span>
                </div>
                <div style="margin-bottom: 5px;">
                    ...
                    <br>
                    <span>
                        "/usr/bin/php [{$oViewConf->getModulePath('tc_cleverreach', "/")}]crons/tc_cleverreach.php orders"
                    </span>
                </div>
            </div>
        [{/if}]
...
[{oxscript include=$oView->getCleverreachModuleUrl("out/src/js/tc_cleverreach_start.js") }]
