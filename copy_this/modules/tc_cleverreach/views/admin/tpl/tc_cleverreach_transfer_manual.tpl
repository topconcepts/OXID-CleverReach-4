...
[{include file="headitem.tpl" box="export "
    ...
    meta_refresh_url=$oViewConf->getSelfLink()|cat:"&cl=tc_cleverreach_transfer_manual&iStart=$iStart&fnc=$function&iReceiver=$iReceiver&transfer=$transfer&shopId=$shopId&full=$full&offset=$offset"
}]
